...
upImg.show = function(o){
 ...
 function validate(form){
  ...
  if(img!="")return ObjectManager("upload",img);
  return true;
 }
 //-->
</script>
...
<%--显示表单--%>
<html:form action="/user?method=regUser" styleClass="validate" focus="loginName" enctype="multipart/form-data" onsubmit="return validate(this);">
    <div style="border-bottom: 0pt none;text-align:center;" class="topt">
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%" class="table">
            ...
            <tr>
             ...
             <td valign="bottom" align="left"><input type="file" name="avatarResource" size="30" style="height:18px;" onchange="javascript:upImg.show(this)"/>
             </td>
            </tr>
            <tr>
                <td>输入密码：</td>
