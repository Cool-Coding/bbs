...
<html>
  ...
  <html:form action="/theme/manage" method="post" focus="title" enctype="multipart/form-data" onsubmit="return submitForm(this)">
    <!-- 隐藏元素method -->
   ...
   <table>
     <tr>
      ...
      <td  class="user"><label title="${theme.user.nickname}">${theme.user.nickname}</label></td>
     </tr>
     <tr>
     ...
     <tr>
      ...
      <td><html:text property="forumName" disabled="true"/><input type="button" value="修改" id="changeForum" onclick='javascript:window.open("<html:rewrite action='/index'/>?simpleForumList=true&id=${themeform.forumId}","板块列表","300px","200px")'/></td>
     </tr>
      <tr height="320px">
