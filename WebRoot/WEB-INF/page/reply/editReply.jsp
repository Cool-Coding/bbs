...
<html>
  ...
  <html:form action="/control/reply/manage" method="post" enctype="multipart/form-data" onsubmit="javascript:return submitForm(this)">
    <!-- 隐藏元素method -->
    ...
    <!-- 用户名称 -->
    <input type="hidden" name="author" value="${reply.user.loginName}"/>
   <!-- 回复所在的帖子-->
   <html:hidden property="replyId"/>
   <table>
      <tr height="320px">
      <td width="5%"></td>
      <td><textarea name="content">${reply.content}</textarea>
		<script type="text/javascript">
